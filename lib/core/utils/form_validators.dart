...
class FormValidators {
  ...
  static MultiValidator password([
    ...
    return MultiValidator([
      ...
      MinLengthValidator(
        6,
        errorText: 'Password should be more than 5 characters long.',
      )
    ]);
  }
  ...
  static TextFieldValidator phoneNumber() {
    return _PhoneNumberValidator(
      errorText: 'Please enter a valid number (98########).',
    );
  }

  static MultiValidator duration([
    String message = 'Please enter a duration.',
  ]) {
  ...
  static MultiValidator checkpoints() {
    return MultiValidator([
      _NonEmptyListValidator(
        errorText: 'Please create at least one checkpoint.',
      ),
